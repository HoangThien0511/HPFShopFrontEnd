...
const DetailProduct = (props: Props) => {
  ...
  const onFinish = (values: any) => {
    if (!userInfo || userInfo == null) {
      ...
      const cartUser = dataAllCart.filter(
        (itemCart: Icart) => itemCart.userId == userInfo.id
      );

      const checkCart = cartUser.filter(
        (itemCart: Icart) => itemCart.idProduct == id
      );

      const checkUpdate = cartUser.filter(
        (itemCart: any) =>
          itemCart.color == productCart.color &&
          itemCart.size["size"] == productCart.size["size"]
      );
      ...
      if (checkUpdate.length > 0) {
        ...
        updateCart(cartUpdate)
          .then(message.success("Thêm sản phẩm vào giỏ hàng thành công!"))
          .catch((error) => {
  ...
  if (isLoading)
    return <div className="detail_product">Đang tải dữ liệu...</div>;
  return (
              ...
              <div className="product__details__text">
                ...
                <div className="product__details__price">
                  {valuePrice == 0
                    ...
                    : valuePrice.toLocaleString("vi-VN", {
                        style: "currency",
                        currency: "VND",
                      })}
                  <span>
                ...
                <div className="product__details__widget">
                  <Form
                    ...
                    className="form_cart"
                  >
                    <Form.Item label="MÀU SẮC" name="product_color">
                      {product.product_color.map(
                        (item_color: any, index: number) => {
                          return (
                            <Radio.Group
                              key={index}
                    ...
                    <Form.Item label="SIZE" name="product_size">
                      {product.product_size.map(
                        (item_size: any, indexSize: number) => {
                          return (
                            <Radio.Group
                              key={indexSize}
                    ...
                    <Form.Item label="SỐ LƯỢNG" name="product_quantity">
                      <Button
          ...
          <div className="row">
            ...
            <div className="col-lg-3 col-md-4 col-sm-6">
              <div className="product__item">
                <div
                  ...
                  style={{ backgroundImage: `url(${rp_1})` }}
                >
                  <div className="label new">New</div>
                  <ul className="product__hover">
                    <li>
                      <Link to={rp_1} className="image-popup">
            ...
            <div className="col-lg-3 col-md-4 col-sm-6">
              <div className="product__item">
                <div
                  className="product__item__pic set-bg"
                  style={{ backgroundImage: `url(${rp_2})` }}
                >
                  <ul className="product__hover">
                    <li>
                      <Link to={rp_2} className="image-popup">
                        <span className="arrow_expand" />
                      </Link>
                    </li>
                    <li>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6">
              <div className="product__item">
                <div
                  className="product__item__pic set-bg"
                  style={{ backgroundImage: `url(${rp_3})` }}
                >
                  <div className="label stockout">out of stock</div>
                  <ul className="product__hover">
                    <li>
                      <Link to={rp_3} className="image-popup">
                        <span className="arrow_expand" />
                      </Link>
                    </li>
                    <li>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6">
              <div className="product__item">
                <div
                  className="product__item__pic set-bg"
                  style={{ backgroundImage: `url(${rp_4})` }}
                >
                  <ul className="product__hover">
                    <li>
                      <Link to={rp_4} className="image-popup">
                        <span className="arrow_expand" />
                      </Link>
                    </li>
                    <li>
          ...
          <div className="row">
            <div className="col-lg-2 col-md-4 col-sm-4 p-0">
              <div
                ...
                style={{ backgroundImage: `url(${insta_1})` }}
              >
            ...
            <div className="col-lg-2 col-md-4 col-sm-4 p-0">
              <div
                className="instagram__item set-bg"
                style={{ backgroundImage: `url(${insta_2})` }}
              >
                <div className="instagram__text">
                  <i className="fa fa-instagram" />
                  <Link to="#">@ ashion_shop</Link>
            ...
            <div className="col-lg-2 col-md-4 col-sm-4 p-0">
              <div
                className="instagram__item set-bg"
                style={{ backgroundImage: `url(${insta_3})` }}
              >
                <div className="instagram__text">
                  <i className="fa fa-instagram" />
                  <Link to="#">@ ashion_shop</Link>
            ...
            <div className="col-lg-2 col-md-4 col-sm-4 p-0">
              <div
                className="instagram__item set-bg"
                style={{ backgroundImage: `url(${insta_4})` }}
              >
                <div className="instagram__text">
                  <i className="fa fa-instagram" />
                  <Link to="#">@ ashion_shop</Link>
            ...
            <div className="col-lg-2 col-md-4 col-sm-4 p-0">
              <div
                className="instagram__item set-bg"
                style={{ backgroundImage: `url(${insta_5})` }}
              >
                <div className="instagram__text">
                  <i className="fa fa-instagram" />
                  <Link to="#">@ ashion_shop</Link>
            ...
            <div className="col-lg-2 col-md-4 col-sm-4 p-0">
              <div
                className="instagram__item set-bg"
                style={{ backgroundImage: `url(${insta_6})` }}
              >
                <div className="instagram__text">
                  <i className="fa fa-instagram" />
                  <Link to="#">@ ashion_shop</Link>
